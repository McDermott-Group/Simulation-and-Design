%Find geometry for a given impedance of CPW

function CPW(e_r, h, S, Z0, f0, theta)
    ...
    disp(['Target Impedance: ' num2str(Z0) ' Ohms']);
    disp(['Calc. Impedance: ' num2str(Z), ' Ohms']);
    ...
    disp(['Length of Half Wavelength Line: ' num2str(L4/1e-6) ' microns']);
    disp(['Capacitance per unit length: ' num2str(C_cpw) ' F/m']);
    disp(['Inductance per unit length: ' num2str(l) ' H/m']);
